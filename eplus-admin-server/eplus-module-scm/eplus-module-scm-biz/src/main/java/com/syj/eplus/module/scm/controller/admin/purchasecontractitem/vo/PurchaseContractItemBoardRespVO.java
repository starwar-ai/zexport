...
public class PurchaseContractItemBoardRespVO implements ChangeExInterface {
    ...
    @Schema(description = "图片")
    @ExcelProperty("图片")
    private SimpleFile productPicUrl;
    ...
    @ExcelProperty(value = "已开票金额", converter = AmountConvert.class)
    @CompareField
