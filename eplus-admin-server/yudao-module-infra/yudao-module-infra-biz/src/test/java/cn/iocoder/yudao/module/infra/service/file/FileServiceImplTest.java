...
public class FileServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFile_success() throws Exception {
        ...
        String name = "单测文件名";
        // 调用
        String result = fileService.createFile(null, name, path, content).getFileUrl();
        // 断言
        ...
        assertEquals(url, file.getFileUrl());
        assertEquals("image/jpeg", file.getFileType());
