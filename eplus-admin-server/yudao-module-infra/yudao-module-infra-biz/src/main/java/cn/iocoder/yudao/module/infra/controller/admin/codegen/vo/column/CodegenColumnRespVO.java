...
public class CodegenColumnRespVO {
    ...
    @Schema(description = "是否resp需要返回名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "true")
    private Boolean requireName;

    @Schema(description = "resp返回名称字段")
    private String javaNameField;

    @Schema(description = "返回名称类型")
    private String nameType;

    @Schema(description = "excel转换类型")
    private String convertType;

    @Schema(description = "typeHandler类")
