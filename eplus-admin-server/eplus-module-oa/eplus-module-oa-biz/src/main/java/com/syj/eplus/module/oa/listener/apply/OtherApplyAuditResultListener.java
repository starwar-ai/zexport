...
@Component
public class OtherApplyAuditResultListener extends BpmProcessInstanceResultEventListener {
    @Resource
    private ApplyService applyService;
    @Override
    protected String getProcessDefinitionKey() {
        return applyService.getProcessDefinitionKey(ReimbTypeEnum.OTHER.getValue());
    }
