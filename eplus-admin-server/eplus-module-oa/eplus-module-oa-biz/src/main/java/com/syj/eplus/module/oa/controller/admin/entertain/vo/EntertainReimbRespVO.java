...
public class EntertainReimbRespVO {
    ...
    @Schema(description = "申请单编号", example = "13687")
    ...
    @ExcelProperty(value = "招待对象类型", converter = DictConvert.class)
    @DictFormat(DictTypeConstants.ENTERTAIN_EXPENSE_TYPE)
    private Integer entertainType;

    @Schema(description = "招待对象名称")
    @ExcelProperty(value = "招待对象名称")
    private String entertainName;

    @Schema(description = "招待对象等级")
    @ExcelProperty(value = "招待对象等级", converter = DictConvert.class)
    @DictFormat(DictTypeConstants.LEVEL_TYPE)
    ...
    @ExcelProperty(value = "招待陪同人员", converter = UserDeptListConverter.class)
    private List<UserDept> entertainEntourage;

    @Schema(description = "报销发票列表")
