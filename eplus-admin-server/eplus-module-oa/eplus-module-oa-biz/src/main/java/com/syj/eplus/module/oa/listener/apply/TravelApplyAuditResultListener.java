...
@Component
public class TravelApplyAuditResultListener extends BpmProcessInstanceResultEventListener {
    @Resource
    private ApplyService applyService;
    @Override
    protected String getProcessDefinitionKey() {
        return applyService.getProcessDefinitionKey(ReimbTypeEnum.TRAVEL.getValue());
    }
