...
@Component
public class EntertainApplyAuditResultListener extends BpmProcessInstanceResultEventListener {
    @Resource
    private ApplyService applyService;
    @Override
    protected String getProcessDefinitionKey() {
        return applyService.getProcessDefinitionKey(ReimbTypeEnum.ENTERTAIN.getValue());
    }
