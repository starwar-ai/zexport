...
public enum BpmProcessInstanceResultEnum {
    ...
    public static String getDescByResult(Integer result) {
        for (BpmProcessInstanceResultEnum bpmProcessInstanceResultEnum : BpmProcessInstanceResultEnum.values()) {
            if (bpmProcessInstanceResultEnum.getResult().equals(result)) {
                return bpmProcessInstanceResultEnum.getDesc();
            }
        }
        return null;
    }
