...
public interface ErrorCodeConstants {
    ...
    ErrorCode OA_DEPART_BM_POST_NOT_EXISTS = new ErrorCode(1_009_001_005, "{}部门的负责人不存在");
    ...
    ErrorCode UNDERREVIEW_EDITING_NOT_ALLOWED = new ErrorCode(1_009_001_008, "审核中,禁止修改");
    ...
    ErrorCode FORM_VARIABLE_NOT_EXISTS = new ErrorCode(1_009_004_003, "流程变量不存在");

    ErrorCode PROCESS_INSTANCE_ID_CODE_NOT_EXISTS = new ErrorCode(1_009_004_004, "流程实例不存在，请传入正确的流程实例id或编号");
    ErrorCode PROCESS_INSTANCE_EXT_NOT_EXISTS = new ErrorCode(1_009_004_005, "流程实例拓展不存在，请传入正确的流程实例id或编号");
    ErrorCode STARAT_USER_NOT_NULL = new ErrorCode(1_009_004_006, "流程发起人不能为空");
    ...
    ErrorCode TASK_TRANSFER_FAIL_USER_REPEAT = new ErrorCode(1_009_005_015, "任务转办失败，转办人和当前审批人为同一人");
    ErrorCode PROCESS_INSTANCE_KEY_EXISTS = new ErrorCode(1_009_005_016, "流程key为空");
    ErrorCode START_USER_DEPT_NOT_EXISTS = new ErrorCode(1_009_005_017, "找不到流程发起人{}部门");
    ErrorCode SHIPMENT_ITEM_SPEC_IS_NULL = new ErrorCode(1_009_005_018, "出运明细规格列表为空");
