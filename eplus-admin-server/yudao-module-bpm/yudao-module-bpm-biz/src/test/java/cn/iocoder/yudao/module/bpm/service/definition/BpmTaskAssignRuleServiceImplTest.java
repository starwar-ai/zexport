...
public class BpmTaskAssignRuleServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCalculateTaskCandidateUsers_DeptLeader() {
        ...
        // mock 方法
        DeptRespDTO dept1 = randomPojo(DeptRespDTO.class, o -> o.setLeaderUserIds(new HashSet<>()));
        DeptRespDTO dept2 = randomPojo(DeptRespDTO.class, o -> o.setLeaderUserIds(new HashSet<>()));
