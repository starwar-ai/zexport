...
import cn.iocoder.yudao.framework.security.core.aop.FieldPermissionAspect;
...
public class YudaoSecurityAutoConfiguration {
    ...
    @Bean
    public FieldPermissionAspect fieldPermissionAspect(){return new FieldPermissionAspect();}
    /**
     * 认证失败处理类 Bean
     */
    @Bean
