...
public abstract class AbstractFileClient<Config extends FileClientConfig> implements FileClient {
    ...
    protected String formatFileUrl( String path) {
        return StrUtil.format("/infra/file/{}/get/{}", getId(), path);
    }

    @Override
    public void batchDelete(List<String> pathList) throws Exception{
        throw new ExecutionControl.NotImplementedException("尚未实现,敬请期待");
    }
}
