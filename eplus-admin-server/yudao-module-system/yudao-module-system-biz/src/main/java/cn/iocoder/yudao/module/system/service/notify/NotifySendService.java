...
public interface NotifySendService {
    ...
    /**
     * 发送单条站内信给管理后台的用户（带业务关联）
     *
     * @param reqDTO 发送请求
     * @return 发送日志编号
     */
    Long sendSingleNotifyToAdmin(NotifySendSingleToUserReqDTO reqDTO);
    ...
    /**
     * 发送单条站内信给用户 APP 的用户（带业务关联）
     *
     * @param reqDTO 发送请求
     * @return 发送日志编号
     */
    Long sendSingleNotifyToMember(NotifySendSingleToUserReqDTO reqDTO);
