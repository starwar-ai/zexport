...
public class NotifySendServiceImpl implements NotifySendService {
    ...
    @Override
    public Long sendSingleNotifyToAdmin(NotifySendSingleToUserReqDTO reqDTO) {
        return sendSingleNotify(reqDTO.getUserId(), UserTypeEnum.ADMIN.getValue(),
                reqDTO.getTemplateCode(), reqDTO.getTemplateParams(),
                reqDTO.getBusinessType(), reqDTO.getBusinessId(), reqDTO.getBusinessParams());
    }
    ...
    @Override
    public Long sendSingleNotifyToMember(NotifySendSingleToUserReqDTO reqDTO) {
        return sendSingleNotify(reqDTO.getUserId(), UserTypeEnum.MEMBER.getValue(),
                reqDTO.getTemplateCode(), reqDTO.getTemplateParams(),
                reqDTO.getBusinessType(), reqDTO.getBusinessId(), reqDTO.getBusinessParams());
    }
    ...
    public Long sendSingleNotify(Long userId, Integer userType, String templateCode, Map<String, Object> templateParams) {
        return sendSingleNotify(userId, userType, templateCode, templateParams, null, null, null);
    }

    @Override
    public Long sendSingleNotify(Long userId, Integer userType, String templateCode, Map<String, Object> templateParams,
                                 String businessType, String businessId, Map<String, Object> businessParams) {
        // 校验模版
        ...
        if (Objects.equals(template.getStatus(), CommonStatusEnum.DISABLE.getStatus())) {
            ...
            throw exception(NOTIFY_TEMPLATE_CLOSED);
        }
        // 校验参数
        ...
        return notifyMessageService.createNotifyMessage(userId, userType, template, content, templateParams,
                businessType, businessId, businessParams);
    }
