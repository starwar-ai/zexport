...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public List<Long> getSuperAdminRoleIdList() {
        List<RoleDO> roleDOList = roleMapper.selectList(RoleDO::getCode, SUPER_ADMIN);
        if (CollUtil.isNotEmpty(roleDOList)) {
            return roleDOList.stream().map(RoleDO::getId).collect(Collectors.toList());
        }
        return Collections.emptyList();
    }
