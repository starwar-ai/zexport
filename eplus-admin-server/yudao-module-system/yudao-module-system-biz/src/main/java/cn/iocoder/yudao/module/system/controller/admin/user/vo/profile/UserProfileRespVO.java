...
public class UserProfileRespVO {
    ...
    @Schema(description = "第三用id", example = "15601691300")
    ...
    @Schema(description = "账户名称", example = "15601691300")
    private String bankPoc;

    @Schema(description = "开户银行", example = "15601691300")
    private String bank;

    @Schema(description = "账户号码", example = "15601691300")
