...
public class OperateLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetOperateLogPage() {
        ...
        OperateLogDO operateLogDO = RandomUtils.randomPojo(OperateLogDO.class, o -> {
            ...
            o.setModule("order");
            o.setType(OperateTypeEnum.CREATE.getType().toString());
        ...
        // 测试 type 不匹配
        operateLogMapper.insert(cloneIgnoreId(operateLogDO, o -> o.setType(OperateTypeEnum.IMPORT.getType().toString())));
        // 测试 createTime 不匹配
