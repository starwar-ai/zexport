package com.syj.eplus.module.dms.dal.dataobject.declaration;
...
@TableName(value = "dms_declaration", autoResultMap = true)
@KeySequence("dms_declaration_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class DeclarationDO extends BaseDO {
