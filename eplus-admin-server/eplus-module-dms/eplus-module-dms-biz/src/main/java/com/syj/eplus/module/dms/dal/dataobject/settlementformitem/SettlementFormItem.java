...
package com.syj.eplus.module.dms.dal.dataobject.settlementformitem;
...
@TableName(value = "dms_settlement_form_item", autoResultMap = true)
@KeySequence("dms_settlement_form_item_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class SettlementFormItem extends BaseDO {
     ...
     * 结汇单Id
     */
    @Schema(description = "结汇单Id")
    private Long settlementFormId;
    /**
     * 外箱单位
     */
