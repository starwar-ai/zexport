...
defineOptions({ name: 'CommodityInspectionForm' })
...
const saveForm = async () => {
  try {
    ...
    await CommodityInspectionApi.updateCommodityInspection(paramsResult)
...
onMounted(async () => {
  if (props.mode === 'edit') {
    loading.value = true
    let res = await CommodityInspectionApi.getCommodityInspectionInfo({ id: props.id })
