    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['system:settlement:create']"
        >
          <Icon
            icon="ep:plus"
            class="mr-5px"
      ...
      >
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['system:settlement:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['system:settlement:delete']"
          >
            删除
          </el-button>
        </template>
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await SettlementApi.deleteSettlement(id)
...
const handleExport = async () => {
  try {
    ...
    const data = await SettlementApi.exportSettlement(queryParams)
    download.excel(data, '收款方式名称.xls')
  } catch {
  } finally {
