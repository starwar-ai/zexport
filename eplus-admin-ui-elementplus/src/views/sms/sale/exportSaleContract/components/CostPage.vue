        ...
        return (
          <div class="flex items-center justify-between">
            <el-button
              ...
              v-hasPermi="sms:sale-auxiliary-allocation:allocation"
            >
...
const getInfo = async () => {
  let req = query.id
    ? ExportSaleContractApi.saleContractAuditDetailFee
    : ExportSaleContractApi.saleContractDetailFee
  let res = await req(props.id || query.id || '')
