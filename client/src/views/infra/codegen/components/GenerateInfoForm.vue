    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item
          ...
          prop="auditFlag"
        >
          <el-select v-model="formData.auditFlag">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item
          ...
          prop="codeFlag"
        >
          <el-select v-model="formData.codeFlag">
            <el-option
              v-for="dict in getIntDictOptions(DICT_TYPE.INFRA_BOOLEAN_STRING)"
              :key="dict.value"
              :label="dict.label"
      ...
      <el-col :span="12">
        <el-form-item prop="snType">
          <template #label>
            <span>
              编号类型
              <el-tooltip
                content="用作筛选编号，如:sn_cust"
                placement="top"
              >
                <Icon icon="ep:question-filled" />
              </el-tooltip>
          ...
          <el-input v-model="formData.snType" />
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item prop="codePrefix">
          <template #label>
            <span>
              编号前缀
              <el-tooltip
          ...
          <el-input v-model="formData.codePrefix" />
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item prop="processKey">
          ...
          <el-input v-model="formData.processKey" />
        </el-form-item>
      </el-col>
      <el-col
