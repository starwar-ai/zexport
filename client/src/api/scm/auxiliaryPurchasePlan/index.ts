...
export const getPurchasePlanPage = async (params) => {
  return await request.get({ url: `/scm/auxiliary-purchase-plan/page`, params })
}
// 查询采购计划信息分页
export const getPurchasePlanPageBoard = async (params) => {
  return await request.get({ url: `/scm/auxiliary-purchase-plan/page-board`, params })
}
//获取客户列表
...
export const getPurchasePlan = async (params) => {
  return await request.get({ url: `/scm/auxiliary-purchase-plan/detail`, params })
}

//审核模块的获取详情
export const getAuditpurchasePlan = async (params) => {
  return await request.get({ url: '/scm/auxiliary-purchase-plan/audit-detail', params })
}

// 新增采购计划信息
export const createPurchasePlan = async (data: purchasePlanVO) => {
  return await request.post({ url: `/scm/auxiliary-purchase-plan/create`, data })
}

// 修改采购计划信息
export const updatePurchasePlan = async (data: purchasePlanVO) => {
  return await request.put({ url: `/scm/auxiliary-purchase-plan/update`, data })
}
//转采购合同post
export const purchaseToContract = async (data: purchasePlanVO) => {
  return await request.post({ url: `/scm/auxiliary-purchase-plan/to-contract-save`, data })
}

// 作废
export const finishPurchasePlan = async (data) => {
  return await request.put({ url: `/scm/auxiliary-purchase-plan/batch-finish?planIdList=${data}` })
}

// 删除采购计划信息
export const deletePurchasePlan = async (id: number) => {
  return await request.delete({ url: `/scm/auxiliary-purchase-plan/delete?id=` + id })
}

// 导出采购计划信息 Excel
export const exportPurchasePlan = async (params) => {
  return await request.download({ url: `/scm/auxiliary-purchase-plan/export-excel`, params })
}
...
export const getPayablePurchasePlan = async (params?) => {
  return await request.get({ url: `/scm/auxiliary-purchase-plan/get-simple-list`, params })
}

//采购计划提交
export const submitPurchasePlan = async (id) => {
  return await request.put({ url: `/scm/auxiliary-purchase-plan/submit?paymentId=${id}` })
}
//获取产品精简列表
...
export const toFormalPurchasePlan = async (data) => {
  return await request.put({ url: `/scm/auxiliary-purchase-plan/convert`, data })
}
//获取采购主体
...
export const getTocontractList = async (ids) => {
  return await request.get({
    url: `/scm/auxiliary-purchase-plan/to-contract-list?planItemIdList=${ids}`
  })
}
//根据skucode获取供应商报价详情
export const getVenderQuoteList = async (code) => {
  return await request.get({ url: `/scm/quote-item/list-by-skuid?skuIdList=${code}` })
}
//转采购合同
export const toContract = async (list) => {
  return await request.post({
    url: `/scm/auxiliary-purchase-plan/to-contract?planItemIdList=${list}`
  })
}
