...
public class GeneralReimbRespVO {
    ...
    @Schema(description = "一般费用报销发票列表")
    private List<SimpleFile> invoiceList;

    @Schema(description = "一般费用名称")
    @ExcelProperty(value = "一般费用名称", converter = DictConvert.class)
    @DictFormat(DictTypeConstants.GENERAL_EXPENSE)
    private Integer generalExpense;

    @Schema(description = "实际操作人")
    @ExcelProperty(value = "实际操作人", converter = DictConvert.class)
    @DictFormat(DictTypeConstants.USER_FLAG)
    private Integer userFlag;

    @Schema(description = "实际使用人")
    @ExcelProperty(value = "实际使用人", converter = UserDeptConverter.class)
