 ...
 */
@Component
public class GeneralReimbAuditResultListener extends BpmProcessInstanceResultEventListener {
    @Resource
    ...
    protected String getProcessDefinitionKey() {
        return generalReimbService.getProcessDefinitionKey();
    }
    ...
    protected void onEvent(BpmProcessInstanceResultEvent event) {
        ...
        // 仅处理一般费用报销
        if (!ReimbTypeEnum.GENERAL.getValue().equals(reimbResp.getReimbType())) {
            return;
        }
        ...
        PaymentSaveDTO paymentSaveDTO = new PaymentSaveDTO().setApplyAmount(totalAmountList)
                .setBusinessType(BusinessTypeEnum.GENERAL_APP.getCode())
