...
public class BpmModelController {
    ...
    @Operation(summary = "获得模型精简列表")
    public CommonResult<List<SimpleModelRespVO>> getSimpleModelList(BpmModelPageReqVO pageVO) {
        return success(modelService.getSimpleModelList(pageVO));
    }
}
