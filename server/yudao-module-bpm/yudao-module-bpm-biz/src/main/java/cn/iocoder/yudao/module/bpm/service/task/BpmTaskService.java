...
public interface BpmTaskService {
     ...
     * @param reqVO  通过请求
     */
    Task approveTask(Long userId, @Valid BpmTaskApproveReqVO reqVO);
     ...
     * @param reqVO  不通过请求
     */
    Task rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO);
    ...
    BpmTaskExtDO getTaskExtListByBpmProcessInstanceId(String processInstanceId);
     ...
     * @return
     */
    BpmTaskExtDO getTaskExtByInstanceId(String processInstanceId);
