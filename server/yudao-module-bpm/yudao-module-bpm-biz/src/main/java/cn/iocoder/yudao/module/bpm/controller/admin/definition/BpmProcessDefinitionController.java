...
//    @PreAuthorize("@ss.hasPermission('bpm:process-definition:query')")
    ...
    @GetMapping("/get-bpmn-xml-by-key")
    @Operation(summary = "通过key获得流程定义的 BPMN XML")
//    @PreAuthorize("@ss.hasPermission('bpm:process-definition:query')")
    public CommonResult<BpmProcessDefinitionRespVO> getProcessDefinitionBpmnXMLByKey(@RequestParam("key") String key) {
        BpmProcessDefinitionRespVO result = bpmDefinitionService.getProcessDefinitionBpmnXMLByKey(key);
