...
public class CodegenTableSaveReqVO {
    ...
    @Schema(description = "作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "guoliang.du")
    ...
    @Schema(description = "是否需要审核流程")
    private Boolean auditFlag;
    @Schema(description = "是否生成编号")
    private Boolean codeFlag;
    @Schema(description = "是否需要附件")
