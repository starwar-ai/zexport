...
public class CodegenEngine {
    ...
    private static final Map<String, String> SERVER_TEMPLATES = MapUtil.<String, String>builder(new LinkedHashMap<>()) // 有序
            ...
            .put(javaTemplatePath("controller/vo/detailReq"), javaModuleImplVOFilePath("DetailReq"))
            ...
            .put(javaTemplatePath("listener/auditResultListener"), javaModuleImplMainFilePath("listener/${table.businessName}/${table.className}AuditResultListener"))
    ...
    public CodegenEngine() {
        ...
        TemplateConfig.ResourceMode classpath = TemplateConfig.ResourceMode.CLASSPATH;
        config.setResourceMode(classpath);
    ...
    public Map<String, String> execute(CodegenTableDO table, List<CodegenColumnDO> columns,
        ...
        if (!table.getAuditFlag()) {
            templates.remove(javaTemplatePath("listener/auditResultListener"));
            templates.remove(javaTemplatePath("controller/vo/detailReq"));
        }
        // 2. 执行生成
