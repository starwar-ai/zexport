...
public interface SmsFrameworkErrorCodeConstants {
    ...
    // Alibaba Cloud: The frequency of SMS sending is limited within a normal business traffic control range. Default SMS verification code: Using the same signature, for the same mobile phone number verification code, supports 1 message/minute, 5 messages/hour, up to 10 messages/day.
