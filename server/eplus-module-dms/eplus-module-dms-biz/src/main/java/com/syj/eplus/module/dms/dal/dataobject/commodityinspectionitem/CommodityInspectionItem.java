package com.syj.eplus.module.dms.dal.dataobject.commodityinspectionitem;
...
@TableName(value ="dms_commodity_inspection_item", autoResultMap = true)
@KeySequence("dms_commodity_inspection_item_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class CommodityInspectionItem extends BaseDO {
     ...
     * 商检单主键
     */
    @Schema(description = "商检单主键")
    private Long commodityInspectionId;
    /**
     * 产品主键
     */
