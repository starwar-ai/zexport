...
public interface PermissionService {
     ...
     */
    void assignUserRole(Long userId, Set<SimpleDefaultRoleVO> roleIds);
     ...
     * @return 用户无权限字段集合
     */
    List<FieldPermissionDTO> getNoPermissionFields(Long userId);
     ...
     * @return
     */
    List<FieldPermissionDTO> getNoPermissionFieldsByRoleId(Long roleId);
    ...
    /**
     * 获得用户拥有指定角色的用户编号数组，从缓存中获取
     *
     * @param roleIds 角色编号数组
     * @return 用户编号数组
     */
    Set<Long> getUserIdListByRoleIds(Collection<Long> roleIds);
     ...
     * @return 角色编号集合
     */
    Set<SimpleDefaultRoleVO> getSimpleUserRoleListByUserId(Long userId);

    Set<Long> getUserIdListByNotInRoleIds(List<Long> roleIdList);
