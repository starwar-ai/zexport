...
public class AuthPermissionInfoRespVO {
    ...
    public static class RoleVO {
        ...
        @Schema(description = "部门数组", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    public static class UserVO {
        ...
        @Schema(description = "部门编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "3245")
        private Long deptId;

        @Schema(description = "部门名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "事业部")
