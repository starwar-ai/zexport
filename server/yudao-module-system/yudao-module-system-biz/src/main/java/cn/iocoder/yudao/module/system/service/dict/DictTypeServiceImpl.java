...
public class DictTypeServiceImpl implements DictTypeService {
    ...
    public void updateDictType(DictTypeSaveReqVO updateReqVO) {
        ...
        //更新配置信息
//        dictSubjectApi.updateSystemDictType(updateObj.getId(),updateObj.getName());
    ...
    public void deleteDictType(Long id) {
        ...
        //删除配置信息
//        dictSubjectApi.deleteBySystemDictTypeId(id);
    }
    ...
    public List<DictTypeRespDTO> getListByTypeList(List<String> typeList) {
        ...
        List<DictTypeDO> doList = dictTypeMapper.selectList(DictTypeDO::getType, typeList);
        if(CollUtil.isEmpty(doList)){
            return null;
        }
        return BeanUtils.toBean(doList,DictTypeRespDTO.class);
    }

    @Override
    public List<DictDataDO> getHsDataUnitList() {
        return dictDataService.getDictDataList(0,"hs_measure_unit");
    }
