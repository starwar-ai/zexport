 ...
 */
@Component
public class DomesticSaleContractAuditResultListener  extends BpmProcessInstanceResultEventListener {
    @Resource
    private SaleContractService saleContractService;

    @Override
    protected String getProcessDefinitionKey() {
        return saleContractService.getDomesticProcessDefinitionKey();
    }
