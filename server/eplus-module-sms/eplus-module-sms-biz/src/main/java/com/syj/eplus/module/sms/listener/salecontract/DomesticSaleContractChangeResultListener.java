...
@Component
public class DomesticSaleContractChangeResultListener extends BpmProcessInstanceResultEventListener {
    @Resource
    ...
    protected void onEvent(BpmProcessInstanceResultEvent event) {
        ...
        } if (BpmProcessInstanceResultEnum.CANCEL.getResult().equals(event.getResult())){
            // 将原合同状态改为未变更
